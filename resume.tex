...
\subsection*{Education}
  \begin{itemize}
    ...
    \textbf{Harvey Mudd College} \hfill
      Claremont, CA\\
    {B.S. in Computer Science, GPA 3.73 \hfill \emph{Class of 2021}}
  \end{itemize}
  \vspace{-2.07em}
...
\item[]
    \parskip=-0.2em
  Proficient : Python | Knowledgeable: C++, C, C\#, Golang, Java, JavaScript, Bash, Prolog, R, web development,
  gdb, pdb, rr
...
\subsection*{Experience}
  \begin{itemize}
    ...
    \begin{itemize}[label=\textbullet]
      \itemsep0.1em
      \item Description of Route Simplification project
      \item Description of Cloud Fleet Metrics project
    \end{itemize}
    \vspace{0.1em}
    \item[]
