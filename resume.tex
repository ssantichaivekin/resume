...
\item[]
    \parskip=-0.3em
  \textbf{In progress:} Machine Learning and Search; Advanced Topics in Algorithms \\
...
\item[]
    \parskip=-0.2em
  Proficient : Python | Knowledgeable: C++, C, C\#, Golang, Java, JavaScript, Bash, Prolog, web development,
  gdb, pdb, rr
...
\subsection*{Experience}
  \begin{itemize}
    ...
    \begin{itemize}[label=\textbullet]
      \itemsep0.1em
      \item Implemented a modified version of Ramer-Douglas-Peucker algorithm to help reduce the number of
      latitude-longitude waypoints in the routing engine for self-driving cars. Used Java.
      \item Developed metrics to measure the consistency of self-driving car constraints such as
      "do not unprotected left turn" and "do not enter school area" between different services in 
